...
Through this project, I became familiar with the use of object-relational mapping in database programming.
I learned how to query, create, modify, and delete tables in MySQL using MySQLdb and SQLAlchemy.
